...
public class Output {
    ...
    int clockNum;
    String IF_Instruction, ID_Instruction, EX_Instruction, MEM_Instruction, WB_Instruction;
    ...
    //    EX_MEM
    // none-controll
    int EX_MEM_PC, EX_MEM_ALUResult, EX_MEM_instruction, EX_MEM_addALU, EX_MEM_readRegister2;
    // controll
    ...
    //    MEM_WB
    // none-controll
    int MEM_WB_memoryData, MEM_WB_ALUResult, MEM_WB_instruction;
    // controll
    ...
    public Output(CPU cpu) throws IOException {
        ...
        try {
            ...
            EX_MEM_instruction = cpu.Ex_MEM.instruction;
            ...
            MEM_WB_instruction = cpu.MEM_WB.instruction;
    ...
    public void getOutput(CPU cpu) throws IOException {
        try (PrintWriter out = new PrintWriter("result.txt")) {
            ...
            out.println("IF_ID Pipeline register informaion :");
            out.println();
            out.println("     PC : " + IF_ID_PC + "     instruction : " + IF_ID_instruction);
            out.println("_____________________________________________________________________________");
            out.println("ID_EX Pipeline register informaion :");
            out.println();
            ...
            out.println("_____________________________________________________________________________");
            out.println("EX_MEM Pipeline register informaion :");
            out.println();
            out.println("     PC : " + EX_MEM_PC + "     instruction : " + EX_MEM_instruction);
            out.println("     ALU result : " + EX_MEM_ALUResult + "     add ALU : " + EX_MEM_addALU + "     readRegister2 : " + EX_MEM_readRegister2);
            ...
            out.println("_____________________________________________________________________________");
            out.println("MEM_WB Pipeline register informaion :");
            out.println();
